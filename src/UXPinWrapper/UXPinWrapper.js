...
import { icon as EuiFunction } from '@elastic/eui/es/components/icon/assets/function';
...
import { icon as keyboardShortcut } from '@elastic/eui/es/components/icon/assets/keyboard_shortcut';
